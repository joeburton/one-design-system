...
export type TokenType =
  ...
  | 'gradient' | 'typography' | 'border' | 'transition' | 'strokeStyle';
...
export type ColorBackgroundToken =
  ...
  | 'color-background-muted'   | 'color-background-emphasis';

export type ColorSurfaceToken =
  | 'color-surface-default' | 'color-surface-raised'
  | 'color-surface-overlay' | 'color-surface-sunken';
...
export type ColorTextToken =
  | 'color-text-default'   | 'color-text-subtle'
  | 'color-text-muted'     | 'color-text-onEmphasis'
  | 'color-text-link'      | 'color-text-linkHover'
  | 'color-text-disabled';

export type ColorBrandToken =
  | 'color-brand-primary'       | 'color-brand-primaryHover'
  | 'color-brand-primaryActive' | 'color-brand-primaryMuted'
  | 'color-brand-primaryBorder' | 'color-brand-primaryText';

export type ColorStatusToken =
  | 'color-status-success'      | 'color-status-successHover'
  | 'color-status-successMuted' | 'color-status-successBorder'
  | 'color-status-successText'
  | 'color-status-warning'      | 'color-status-warningHover'
  | 'color-status-warningMuted' | 'color-status-warningBorder'
  | 'color-status-warningText'
  | 'color-status-error'        | 'color-status-errorHover'
  | 'color-status-errorMuted'   | 'color-status-errorBorder'
  | 'color-status-errorText'
  | 'color-status-info'         | 'color-status-infoHover'
  | 'color-status-infoMuted'    | 'color-status-infoBorder'
  | 'color-status-infoText';

export type SpacingToken =
  | 'spacing-component-xs' | 'spacing-component-sm'
  | 'spacing-component-md' | 'spacing-component-lg'
  | 'spacing-component-xl'
  | 'spacing-layout-xs'    | 'spacing-layout-sm'
  | 'spacing-layout-md'    | 'spacing-layout-lg'
  | 'spacing-layout-xl'    | 'spacing-layout-2xl';

export type BorderRadiusToken =
  | 'borderRadius-button' | 'borderRadius-input'
  | 'borderRadius-card'   | 'borderRadius-badge'
  | 'borderRadius-tooltip';

export type ElevationToken =
  | 'elevation-none' | 'elevation-xs' | 'elevation-sm'
...
export type SemanticToken =
  | ColorBackgroundToken | ColorSurfaceToken | ColorBorderToken
  | ColorTextToken       | ColorBrandToken   | ColorStatusToken
  | SpacingToken         | BorderRadiusToken | ElevationToken
  | TransitionToken;

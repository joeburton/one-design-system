...
const ColorSwatch = ({ name, variable }: { name: string; variable: string }) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
    ...
    <div>
      <div style={{ fontFamily: 'var(--ds-typography-fontFamily-body)', fontSize: 'var(--ds-typography-fontSize-sm)', color: 'var(--ds-color-text-default)' }}>{name}</div>
      <div style={{ fontFamily: 'var(--ds-typography-fontFamily-code)', fontSize: 'var(--ds-typography-fontSize-xs)', color: 'var(--ds-color-text-subtle)' }}>{variable}</div>
    </div>
  </div>
);
...
export const Colours: Story = {
  name: 'Colours',
  render: () => (
    <div style={{ fontFamily: 'var(--ds-typography-fontFamily-body)', color: 'var(--ds-color-text-default)', maxWidth: 800 }}>
...
export const Spacing: Story = {
  name: 'Spacing',
  render: () => (
    <div style={{ fontFamily: 'var(--ds-typography-fontFamily-body)', color: 'var(--ds-color-text-default)' }}>
      <Section title="Component Spacing">
        {(['xs', 'sm', 'md', 'lg', 'xl'] as const).map((size) => (
          <div key={size} style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 12 }}>
            <div style={{
            ...
            <span style={{ fontFamily: 'var(--ds-typography-fontFamily-body)', fontSize: 'var(--ds-typography-fontSize-sm)', color: 'var(--ds-color-text-default)' }}>
              component-{size}
            </span>
            <span style={{ fontFamily: 'var(--ds-typography-fontFamily-code)', fontSize: 'var(--ds-typography-fontSize-xs)', color: 'var(--ds-color-text-subtle)' }}>
...
export const Elevation: Story = {
  name: 'Elevation',
  render: () => (
    <div style={{ fontFamily: 'var(--ds-typography-fontFamily-body)', display: 'flex', gap: 32, flexWrap: 'wrap', padding: 24 }}>
